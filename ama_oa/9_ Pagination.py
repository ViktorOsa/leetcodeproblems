...
class Item:
    ...
    def __lt__(self, other):
        # if ascending, maxheap 
        # if descending, minheap
...
def items_per_page(num_of_items, items, sort_parameter, sort_order, items_per_page, page_number):
    ...
    for item in items:
        ...
        if len(heap) > k: # because its min heap
            print ("here ", heapq.heappop(heap))
...
print(items_per_page(3, [['item1', 10, 15], ['item2', 3, 4], ['item3', 17, 18]], 0, 0, 2, 0))
